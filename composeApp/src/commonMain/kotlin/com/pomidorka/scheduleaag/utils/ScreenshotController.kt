...
class ScreenshotController(internal val graphicsLayer: GraphicsLayer) {
...
fun rememberScreenshotController(): ScreenshotController {
    ...
    return remember(graphicsLayer) { ScreenshotController(graphicsLayer) }
}

fun Modifier.capturable(controller: ScreenshotController): Modifier {
...
private class CapturableModifierNode(
    ...
    fun updateController(newController: ScreenshotController) {
